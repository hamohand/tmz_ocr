...
echo "=== Training v6 : 1187 GT réels (dont 291 Dallet ancien) ==="
echo ""
...
echo ""
echo "=== 2/5 : Copie GT synthétique ==="
cd "$SYNTH"
tar -cf - . | tar -xf - -C "$GT_WSL/"
echo "   ✅ Copié"

echo ""
echo "=== 3/5 : Copie GT réel (1187 paires, SANS filtrage français Dallet ancien) ==="
cd "$REAL"
tar -cf - *.tif *.gt.txt | tar -xf - -C "$GT_WSL/"
echo "   ✅ Copié"
...
echo ""
echo "=== 5/5 : Lancement training v6 ==="
cd "$TESSTRAIN"
